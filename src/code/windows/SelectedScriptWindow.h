...
class SelectedScriptWindow
{
private:
	int selectedScriptByIndex;
public:
	SelectedScriptWindow();
	~SelectedScriptWindow();

	void Render(Application& FD, FileScanner& fileScanner, Script& script, bool& isRunningScript, bool& autoHotReload);
};